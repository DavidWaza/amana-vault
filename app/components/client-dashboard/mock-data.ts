...
import {
  enrichRecommendedArtisan,
  type RecommendedArtisanSeed,
} from "./artisan-profile-details";
...
export const MOCK_ARCHITECTS: Architect[] = [
  ...
  },
  {
    ...
    phone: "08034449876",
    email: "projects@heritagearch.ng",
    verified: true,
    portfolioCount: 41,
...
export const MOCK_CONTRACTORS: MarketplaceContractor[] = [
  {
    id: "con-001",
    name: "BuildRight Nigeria Ltd",
    company: "BuildRight Nigeria Ltd",
    phone: "08091112233",
    email: "bids@buildright.ng",
    verified: true,
    experienceYears: 11,
    rating: 4.8,
    reviewCount: 24,
    bio: "Full-service general contractor for residential duplexes, estates, and mixed-use developments across Abuja and Lagos.",
    specialty: "Residential & commercial builds",
    services: ["General contracting", "Milestone delivery", "BOQ-based bidding"],
  },
  {
    id: "con-002",
    ...
    phone: "08092223344",
    email: "estimates@cornerstone.ng",
    verified: true,
    experienceYears: 8,
    rating: 4.5,
    reviewCount: 16,
    bio: "Trusted builder for churches, schools, and community projects with transparent fixed-fee structures.",
    specialty: "Institutional & community",
    services: ["Design-build", "Phased construction", "Site management"],
  },
  {
    id: "con-003",
    ...
    phone: "08093334455",
    email: "projects@summitbuild.ng",
    verified: true,
    experienceYears: 15,
    rating: 4.9,
    reviewCount: 31,
    bio: "Premium contractor with accelerated delivery guarantees and dedicated project management teams.",
    specialty: "Fast-track delivery",
    services: ["Premium builds", "Accelerated timelines", "Dedicated PM"],
  },
  {
    id: "con-004",
    ...
    phone: "08094445566",
    email: "hello@greenfield.ng",
    verified: true,
    experienceYears: 9,
    rating: 4.6,
    reviewCount: 18,
    bio: "Eco-conscious construction with energy-efficient materials and sustainable site practices.",
    specialty: "Eco-friendly construction",
    services: ["Green builds", "Solar-ready installs", "Sustainable materials"],
  },
];
...
const RECOMMENDED_ARTISAN_SEEDS: RecommendedArtisanSeed[] = [
  {
    id: "art-001",
    ...
    categoryEmoji: "🔧",
    areaLabel: "Gwarinpa",
    bio: "Licensed plumber across Abuja. Residential pipe work, water heaters, and bathroom installs.",
    rating: 4.8,
    completedJobs: 12,
    verified: true,
    isRecommended: true,
  ...
  },
  {
    ...
    categoryEmoji: "🪚",
    areaLabel: "Wuse 2",
    bio: "Custom wardrobes, kitchen cabinets, and POP ceiling finishing for diaspora builds.",
    rating: 4.6,
    completedJobs: 9,
    verified: true,
    isRecommended: true,
    avatarUrl: null,
    phone: "08030000002",
    email: "chinedu.okafor@amana.pro",
  },
  {
    id: "art-003",
    ...
    categoryEmoji: "⚡",
    areaLabel: "Maitama",
    bio: "House wiring, inverter setups, and generator changeover for new construction.",
    rating: 4.9,
    completedJobs: 15,
    verified: true,
    isRecommended: false,
  ...
  },
  {
    ...
    categoryEmoji: "☀️",
    areaLabel: "Garki",
    bio: "Solar panel installs, battery maintenance, and hybrid power systems.",
    rating: 4.7,
    completedJobs: 11,
    verified: true,
    isRecommended: true,
  ...
  },
  {
    ...
    categoryEmoji: "🎨",
    areaLabel: "Lugbe",
    bio: "Interior and exterior painting with moisture sealing for Abuja estates.",
    rating: 4.5,
    completedJobs: 7,
    verified: false,
    isRecommended: false,
    avatarUrl: null,
    phone: "08030000008",
    email: "grace.paint@amana.pro",
  },
];

export const MOCK_RECOMMENDED_ARTISANS: RecommendedArtisan[] =
  RECOMMENDED_ARTISAN_SEEDS.map(enrichRecommendedArtisan);
